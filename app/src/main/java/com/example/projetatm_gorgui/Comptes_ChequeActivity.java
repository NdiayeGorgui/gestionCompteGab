...
public class Comptes_ChequeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comptes__cheque);

        ArrayList<CompteCheque> compteChequeList = new ArrayList<CompteCheque>();
        Guichet guichet = new Guichet();
        guichet.InitCompteCheque(compteChequeList);

        CompteChequeAdapter adapter = new CompteChequeAdapter(this, R.layout.liste_layout_compte, compteChequeList);
